...
class Lapa_Scripts
{
    ...
    public function enqueue_scripts()
    {
        ...
        wp_localize_script('lapa-theme', 'la_theme_config', apply_filters('lapa/filter/global_message_js', array(
            ...
            'i18n' => array(
                'backtext' => esc_attr_x('Back', 'front-view', 'lapa'),
                'compare' => array(
                    'view' => esc_attr_x('View List Compare', 'front-view', 'lapa'),
                    'success' => esc_attr_x('has been added to comparison list.', 'front-view', 'lapa'),
                    'error' => esc_attr_x('An error occurred ,Please try again !', 'front-view', 'lapa')
                ),
                'wishlist' => array(
                    'view' => esc_attr_x('View List Wishlist', 'front-view', 'lapa'),
                    'success' => esc_attr_x('has been added to your wishlist.', 'front-view', 'lapa'),
                    'error' => esc_attr_x('An error occurred, Please try again !', 'front-view', 'lapa')
                ),
                'addcart' => array(
                    'view' => esc_attr_x('View Cart', 'front-view', 'lapa'),
                    'success' => esc_attr_x('has been added to your cart', 'front-view', 'lapa'),
                    'error' => esc_attr_x('An error occurred, Please try again !', 'front-view', 'lapa')
                ),
                'global' => array(
                    'error' => esc_attr_x('An error occurred ,Please try again !', 'front-view', 'lapa'),
                    'comment_author' => esc_attr_x('Please enter Name !', 'front-view', 'lapa'),
                    'comment_email' => esc_attr_x('Please enter Email Address !', 'front-view', 'lapa'),
                    'comment_rating' => esc_attr_x('Please select a rating !', 'front-view', 'lapa'),
                    'comment_content' => esc_attr_x('Please enter Comment !', 'front-view', 'lapa'),
                    'continue_shopping' => esc_attr_x('Continue Shopping', 'front-view', 'lapa'),
                    'cookie_disabled' => esc_attr_x('We are sorry, but this feature is available only if cookies are enabled on your browser', 'front-view', 'lapa')
                )
            ),
            'popup' => array(
