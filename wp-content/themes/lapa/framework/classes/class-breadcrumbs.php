...
class Lapa_Breadcrumbs {
	...
	public function default_labels() {
		...
		$labels = array(
			'browse'              => esc_html_x( 'Browse:', 'front-view', 'lapa' ),
			'home'                => $this->home_title(),
			'error_404'           => esc_html_x( '404 Not Found', 'front-view', 'lapa' ),
			'archives'            => esc_html_x( 'Archives', 'front-view', 'lapa' ),
			'search'              => esc_html_x( 'Search results for &#8220;%s&#8221;', 'front-view', 'lapa' ),
			'paged'               => esc_html_x( 'Page %s', 'front-view', 'lapa' ),
			'archive_minute'      => esc_html_x( 'Minute %s', 'front-view', 'lapa' ),
			'archive_week'        => esc_html_x( 'Week %s', 'front-view', 'lapa' ),
	...
	public function home_title() {
		...
		$title            = esc_html_x( 'Home', 'front-view', 'lapa' );
