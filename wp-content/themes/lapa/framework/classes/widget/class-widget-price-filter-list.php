...
class Lapa_Widget_Price_Filter_List extends WP_Widget {
	...
	public function __construct() {
		$widget_ops  = array(
			...
			'description' => esc_html__( 'Shows a price filter list in a widget which lets you narrow down the list of shown products when viewing product categories.', 'lapa' ),
		);
		$control_ops = array( 'width' => 400, 'height' => 350 );
		parent::__construct( 'la-price-filter-list', esc_html__( '[Lapa] - Price Filter List', 'lapa' ), $widget_ops, $control_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		$base_shop_url = Lapa_Helper::get_base_shop_url();
	...
	public function form( $instance ) {
		...
		?>
		<p><label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e( 'Title:', 'lapa' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>

		<p><label for="<?php echo esc_attr($this->get_field_id( 'text' )); ?>"><?php esc_html_e( 'Content:', 'lapa' ); ?></label>
		...
		<p><?php esc_html_e( 'Enter the price by format: min_price|max_price. Divide price list with linebreaks (Enter). Example:', 'lapa' ); ?></p>
		<p><?php esc_html_e( '100|200', 'lapa' ); ?><br><?php esc_html_e( '200|300', 'lapa' ); ?>
			<br><?php esc_html_e( '300|400', 'lapa' ); ?></p>
		<?php
	}
}
