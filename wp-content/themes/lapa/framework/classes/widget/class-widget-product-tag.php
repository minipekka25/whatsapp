...
class Lapa_Widget_Product_Tag extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'Your most used product tags in cloud format.', 'lapa' );
		$this->widget_id          = 'la_product_tag_cloud';
		$this->widget_name        = esc_html__( '[Lapa] - Product Tags', 'lapa' );
		$this->settings           = array(
			'title' => array(
				'type'  => 'text',
				'std'   => esc_html__( 'Product Tags', 'lapa' ),
				'label' => esc_html__( 'Title', 'lapa' )
			)
		);
