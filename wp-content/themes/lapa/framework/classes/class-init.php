...
class Lapa_Init{
    ...
    public function load_textdomain(){
        load_theme_textdomain( 'lapa', Lapa::$template_dir_path . '/languages' );
        load_child_theme_textdomain( 'lapa', Lapa::$stylesheet_dir_path . '/languages' );
    }
    ...
    public function register_nav_menus(){
        register_nav_menus( array(
            'main-nav'   => esc_attr_x( 'Main Navigation', 'admin-view', 'lapa' ),
            'mobile-nav' => esc_attr_x( 'Mobile Navigation', 'admin-view', 'lapa' ),
            'aside-nav'  => esc_attr_x( 'Aside Navigation', 'admin-view', 'lapa' ),
            'shop-category-nav'  => esc_attr_x( 'Category Navigation ( For header 7 )', 'admin-view', 'lapa' ),
        ) );
    }
    ...
    public function widget_init(){
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Sidebar Widget Area', 'admin-view', 'lapa' ),
            'id'            => 'sidebar-primary',
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Sidebar Shop Filter', 'admin-view', 'lapa' ),
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Aside Header Widget Area', 'admin-view', 'lapa' ),
            'id'            => 'aside-widget',
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => '</div>',
            'before_title'  => '<h3 class="widget-title"><span>',
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Header Bottom Widget Area', 'admin-view', 'lapa' ),
            'desc'          => esc_attr_x( 'Apply for only header layout 5,7', 'admin-view', 'lapa' ),
        ...
        register_sidebar( array(
            'name'          => esc_attr_x( 'Footer Widget Area Column 1', 'admin-view', 'lapa' ),
            'id'            => 'f-col-1',
        ...
        register_sidebar( array(
            'name'          => esc_attr_x( 'Footer Widget Area Column 2', 'admin-view', 'lapa' ),
            'id'            => 'f-col-2',
            'before_widget' => '<div id="%1$s" class="widget %2$s"><div class="widget-inner">',
            'after_widget'  => '</div></div>',
            'before_title'  => '<h3 class="widget-title"><span>',
        ...
        register_sidebar( array(
            'name'          => esc_attr_x( 'Footer Widget Area Column 3', 'admin-view', 'lapa' ),
            'id'            => 'f-col-3',
            'before_widget' => '<div id="%1$s" class="widget %2$s"><div class="widget-inner">',
            'after_widget'  => '</div></div>',
            'before_title'  => '<h3 class="widget-title"><span>',
        ...
        register_sidebar( array(
            'name'          => esc_attr_x( 'Footer Widget Area Column 4', 'admin-view', 'lapa' ),
            'id'            => 'f-col-4',
            'before_widget' => '<div id="%1$s" class="widget %2$s"><div class="widget-inner">',
            'after_widget'  => '</div></div>',
            'before_title'  => '<h3 class="widget-title"><span>',
        ...
        register_sidebar( array(
            'name'          => esc_attr_x( 'Footer Widget Area Column 5', 'admin-view', 'lapa' ),
            'id'            => 'f-col-5',
            'before_widget' => '<div id="%1$s" class="widget %2$s"><div class="widget-inner">',
            'after_widget'  => '</div></div>',
            'before_title'  => '<h3 class="widget-title"><span>',
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Custom Block Top', 'admin-view', 'lapa' ),
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Custom Block Inner Top', 'admin-view', 'lapa' ),
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Custom Block Inner Bottom', 'admin-view', 'lapa' ),
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Custom Block Bottom', 'admin-view', 'lapa' ),
        ...
        if(!empty($dynamic_sidebar)){
            foreach($dynamic_sidebar as $sidebar){
                ...
                register_sidebar(array(
                    ...
                    'description'   => sprintf(_x('ID:{{%s}} ', 'admin-view', 'lapa'), sanitize_title($sidebar['sidebar_id'])) . (!empty($sidebar['sidebar_desc']) ? esc_html($sidebar['sidebar_desc']) : ''),
                    'before_widget' => '<div id="%1$s" class="widget %2$s">',
                    'after_widget'  => '</div>',
                    'before_title'  => '<h3 class="widget-title"><span>',
                    'after_title'   => '</span></h3>',
