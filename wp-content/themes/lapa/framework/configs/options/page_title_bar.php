...
function lapa_options_section_page_title_bar( $sections ) {
    ...
    $page_title_layout = array(
        'hide' => esc_html_x("Don't show", 'admin-view', 'lapa')
    );
    $page_title_layout = $page_title_layout + Lapa_Options::get_config_page_title_bar_opts(false);

    $desc1 = esc_html_x('For page title bar', 'admin-view', 'lapa');
    $desc2 = esc_html_x('For page title bar of WooCommerce', 'admin-view', 'lapa');
    ...
    $sections['page_title_bar'] = array(
        ...
        'sections' => array(
            array(
                ...
                'title'     => esc_html_x('Global Page Title', 'admin-view', 'lapa'),
                'icon'      => 'fa fa-plus',
                'fields'    => array(
                    array(
                        ...
                        'type'          => 'select',
                        'class'         => 'chosen',
                        'title'         => esc_html_x('Select Layout', 'admin-view', 'lapa'),
                        'desc'          => $desc1,
                    ...
                    array(
                        ...
                        'title'         => esc_html_x('Replace breadcrumb by custom text', 'admin-view', 'lapa'),
                        'desc'          => $desc1,
                    ...
                    array(
                        ...
                        'type'      => 'responsive',
                        'title'     => esc_html_x('Page Title Font Size', 'admin-view', 'lapa'),
                        'desc'      => esc_html_x('Enter the font size (e.g: 20px )', 'admin-view', 'lapa')
                    ),
                    ...
                    array(
                        ...
                        'type'      => 'spacing',
                        'title'     => esc_html_x('Spacing', 'admin-view', 'lapa'),
                        'desc'      => $desc1,
                        'unit' 	    => 'px',
                        'default'   => array(
                            'top' => 40,
                    ...
                    array(
                        ...
                        'type'      => 'spacing',
                        'title'     => esc_html_x('Spacing', 'admin-view', 'lapa'),
                        'desc'      => esc_html_x('For page title bar on Tablet', 'admin-view', 'lapa'),
                        'unit' 	    => 'px',
                        'default'   => array(
                            'top' => 25,
                            'bottom' => 25
                    ...
                    array(
                        ...
                        'type'      => 'spacing',
                        'title'     => esc_html_x('Spacing', 'admin-view', 'lapa'),
                        'desc'      => esc_html_x('For page title bar on Mobile', 'admin-view', 'lapa'),
                        'unit' 	    => 'px',
                        'default'   => array(
                            'top' => 25,
                            'bottom' => 25
            ...
            array(
                ...
                'title'     => esc_html_x('WooCommerce Page Title Bar', 'admin-view', 'lapa'),
                'fields'    => array(
                    array(
                        ...
                        'class'     => 'la-radio-style',
                        'default'   => 'off',
                        'title'     => esc_html_x('Enable Override', 'admin-view', 'lapa'),
                        'desc'      => esc_html_x('Turn on to override all setting page title bar of WooCommerce Settings ( Shop page/Product details/Product Category/ Product tags and search page )', 'admin-view', 'lapa'),
                        'info'      => esc_html_x('This option will not work with these pages were overwritten', 'admin-view', 'lapa'),
                    ...
                    array(
                        ...
                        'type'          => 'select',
                        'class'         => 'chosen',
                        'title'         => esc_html_x('WooCommerce Page Title Bar Layout', 'admin-view', 'lapa'),
                        'options'       => $page_title_layout,
                    ...
                    array(
                        ...
                        'title'     => esc_html_x('Spacing', 'admin-view', 'lapa'),
                        'dependency'=> array('woo_override_page_title_bar_on|woo_page_title_bar_layout', '==|!=', 'true|hide'),
                        'desc'      => esc_html_x('For page title bar of WooCommerce on Tablet', 'admin-view', 'lapa'),
                        'unit' 	    => 'px',
                        'default'   => array(
                            'top' => 25,
                            'bottom' => 25
                    ...
                    array(
                        ...
                        'title'     => esc_html_x('Spacing', 'admin-view', 'lapa'),
                        'dependency'=> array('woo_override_page_title_bar_on|woo_page_title_bar_layout', '==|!=', 'true|hide'),
                        'desc'      => esc_html_x('For page title bar of WooCommerce on Mobile', 'admin-view', 'lapa'),
                        'unit' 	    => 'px',
                        'default'   => array(
                            'top' => 25,
                            'bottom' => 25
