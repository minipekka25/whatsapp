    ...
    $sections['page_title_bar'] = array(
        ...
        'fields'        => array(
            array(
                ...
                'desc'          => esc_html_x('Choose to show or hide the page title bar.', 'admin-view', 'lapa'),
            ...
            array(
                ...
                'title'         => esc_html_x('Hide Breadcrumbs', 'admin-view', 'lapa'),
            ...
            array(
                ...
                'default'       => 'no',
                'class'         => 'la-radio-style',
                'title'         => esc_html_x('Hide Page Title', 'admin-view', 'lapa'),
                'options'       => Lapa_Options::get_config_radio_opts(false),
                'dependency'    => array( 'page_title_bar_layout', '!=', 'hide' )
            ),
            array(
                ...
                'type'          => 'text',
                'title'         => esc_html_x('Page Title Bar Custom','admin-view', 'lapa'),
            ...
            array(
                ...
                'default'       => 'no',
                'class'         => 'la-radio-style',
                'title'         => esc_html_x('Enable Custom Style', 'admin-view', 'lapa'),
                'options'       => Lapa_Options::get_config_radio_opts(false),
                'dependency'    => array( 'page_title_bar_layout', '!=', 'hide' )
            ),
            ...
            array(
                ...
                'desc'          => esc_html_x('For page title bar', 'admin-view', 'lapa'),
