...
$shortcode_params = array(
    ...
    array(
        ...
        'default' => 'h5',
        'description' => __('Default is H5', 'lastudio'),
        'group' => __('Item Settings', 'lastudio')
    ),
    ...
    array(
        ...
        'params' => array(
            ...
            array(
                'type' 			=> 'textfield',
                'heading' 		=> __('Custom Image Size', 'lastudio'),
                'param_name' 	=> 's',
                'description' 	=> __('leave blank to inherit from parent settings', 'lastudio')
            ),
        ),
        'dependency' => array(
