...
class LaStudio {
	...
	*/
	private function load_dependencies() {
		...
		*/
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/lastudio-functions.php';

		/**
		* The class responsible for orchestrating the actions and filters of the
		* core plugin.
		*/
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-lastudio-loader.php';

		/**
		* The class responsible for defining internationalization functionality
		* of the plugin.
		*/
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-lastudio-i18n.php';

		/**
		* The class responsible for defining all actions that occur in the admin area.
		*/
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-lastudio-admin.php';

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-lastudio-theme-options.php';

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-lastudio-metabox.php';

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-lastudio-content-type.php';

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-lastudio-shortcode-manager.php';

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-lastudio-taxonomy.php';

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-lastudio-theme-customize.php';
		...
		* Shortcodes
		*/
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/extensions/shortcodes/class-lastudio-shortcodes.php';

		/**
		* Load WooCommerce ThreeSixty
		*/
		if(!empty($this->extensions['360'])) {
			require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/extensions/threesixty/class-lastudio-woocommerce-threesixty.php';
		}
		...
		*/
		...
		if(!empty($this->extensions['swatches'])){
			require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/extensions/swatch/class-lastudio-swatch-attribute-configuration-object.php';
			require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/extensions/swatch/class-lastudio-swatch-term.php';
			require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/extensions/swatch/class-lastudio-swatch-product-term.php';
			require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/extensions/swatch/class-lastudio-swatch.php';
			require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/extensions/swatch/functions.php';
		}
		...
		* side of the site.
		*/
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-lastudio-public.php';
	...
	*/
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_footer', $plugin_admin, 'render_popup_icons' );
		$this->loader->add_action( 'customize_controls_print_footer_scripts', $plugin_admin, 'render_popup_icons' );
		$this->loader->add_action( 'admin_footer', $plugin_admin, 'render_dlicon' );
		$this->loader->add_action( 'customize_controls_print_footer_scripts', $plugin_admin, 'render_dlicon' );
	...
	*/
	...
	public function add_fonts_to_visual_composer( $font_name ){
		...
		if( 'la_icon_outline' == $font_name ){
			...
			if(!isset($la_external_icon_font[$font_name])){
